...
| Sketchnote by [@sketchthedocs](https://sketchthedocs.dev) is unavailable in this repo snapshot. |
| :----------------------------------------------------------------------------------------------------: |
|              Defining Data Science - _Sketchnote by [@nitya](https://twitter.com/nitya)_               |

---

[Defining Data Science Video](https://youtu.be/beZ7Mb_oz9I)
...
Word cloud preview is unavailable in this repo snapshot.
