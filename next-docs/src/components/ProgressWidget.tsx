  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      ...
      {user ? (
        ...
        <button 
          onClick={handleLogin} 
          className="bg-gray-900 text-white dark:bg-white dark:text-black border border-transparent shadow-lg rounded-full px-3 py-1.5 flex items-center gap-2 text-xs font-medium hover:opacity-90 transition-opacity"
        >
