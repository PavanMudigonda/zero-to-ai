...
> **Status:** Complete — environment setup guide is fully available. Quick-start in 5 minutes, or follow the detailed setup walkthrough below.
...
4. **Begin Learning**: Read the [curriculum overview](https://zero-to-ai.dev/), skim the [Glossary](https://zero-to-ai.dev/23-glossary/01_GLOSSARY), then open the first phase for your track

**Not ready?** See detailed setup below.

If you are unsure where to go after setup, use this order:

1. [curriculum overview](https://zero-to-ai.dev/)
2. [Glossary](https://zero-to-ai.dev/23-glossary/01_GLOSSARY)
3. [Python phase](https://zero-to-ai.dev/01-python) if you need Python fundamentals
...
This folder is for environment setup and orientation only. The canonical curriculum navigation lives in [zero-to-ai.dev](https://zero-to-ai.dev/).
...
git sparse-checkout set jupyter-notebooks/02-data-science jupyter-notebooks/06-neural-networks jupyter-notebooks/11-prompt-engineering
```
...
- ✅ Review the [Glossary](https://zero-to-ai.dev/23-glossary/01_GLOSSARY) for terminology
- ✅ Read the [curriculum overview](https://zero-to-ai.dev/) and choose your track
- ✅ If new to Python, start with [01-python/](../01-python/)

### Phase 1: Foundations (Weeks 1-8)
- **Lesson 1**: [Python & Data Science](https://zero-to-ai.dev/02-data-science) - 278 notebooks
- **Lesson 2**: [Mathematics for ML](https://zero-to-ai.dev/03-maths) - Linear algebra, calculus, stats
...
2. ✅ **Choose a Track**: Read the [curriculum overview](https://zero-to-ai.dev/)
3. ✅ **Review the Glossary**: Read the [Glossary](https://zero-to-ai.dev/23-glossary/01_GLOSSARY) for terminology
4. ✅ **Start Learning**: Begin with [01-python/](https://zero-to-ai.dev/01-python) if new to Python, otherwise start with the first phase for your chosen track
5. ✅ **Track Progress**: Use [https://zero-to-ai.dev/](https://zero-to-ai.dev/) once you begin
...
1. **Check [02_troubleshooting.md](https://zero-to-ai.dev/00-course-setup/02_troubleshooting)** for detailed solutions
...
- [ ] Familiar with the [Glossary](https://zero-to-ai.dev/23-glossary/01_GLOSSARY) terms you will see early on
- [ ] Reviewed the [curriculum overview](https://zero-to-ai.dev/) or the visual roadmap for your chosen track

## 🎓 Ready to Start?

**Congratulations!** 🎉 You're all set up and ready to begin your AI journey!

**Next Stop**: [Lesson 1: Python & Data Science →](https://zero-to-ai.dev/02-data-science)

---

**📚 Additional Resources**

- [Main README](https://github.com/PavanMudigonda/zero-to-ai) - Repository overview
