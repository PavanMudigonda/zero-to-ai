...
### Fixed
- `15-ai-agents/README.md` — Updated notebook listing to reflect all 9 notebooks (was showing only 6)
- `08-rag/README.md` — Removed reference to non-existent `projects/` directory, updated module structure to match actual files
- `README.md` — Removed non-existent `23-advanced-mathematics/` directory from structure, added missing `28-practical-data-science/`
- `COMPARISON_MATRICES.md` — Updated date to March 2026, added DeepSeek R1/V3, o3/o3-mini, Gemini 2.0 Pro models
- `00-course-setup/README.md` — Fixed script reference from `view_progress.py` to `progress_tracker.py`
...
- Phase 24: Advanced Deep Learning (39 notebooks — GANs, VAEs, NeRF, Diffusion, BNNs)
- Phase 25: Reinforcement Learning (6 notebooks — MDP, Q-Learning, TD Learning)
- Phase 26: Time Series Analysis (6 notebooks — ARIMA, Prophet, Neural Forecasting)
- Phase 27: Causal Inference (7 notebooks — DAGs, RCTs, Propensity Scores, DiD)
