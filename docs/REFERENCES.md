...
|------|-------|-------------|
| [scikit-learn/scikit-learn](https://github.com/scikit-learn/scikit-learn) | 60k+ | Industry-standard ML library; study examples folder |
| [ageron/handson-ml3](https://github.com/ageron/handson-ml3) | 28k+ | Hands-On ML book notebooks (excellent quality) |
| [rasbt/machine-learning-book](https://github.com/rasbt/machine-learning-book) | 5k+ | ML with scikit-learn, Keras, TensorFlow book code |
| [microsoft/ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners) | 70k+ | 26 lessons, curriculum-style |
...
| [lucidrains/x-transformers](https://github.com/lucidrains/x-transformers) | 4k+ | Clean transformer implementations |

### LLMs and NLP

| Repo | Stars | Why Study It |
|------|-------|-------------|
| [huggingface/transformers](https://github.com/huggingface/transformers) | 140k+ | Industry standard; study examples and model cards |
| [huggingface/peft](https://github.com/huggingface/peft) | 17k+ | LoRA/QLoRA fine-tuning library |
| [huggingface/trl](https://github.com/huggingface/trl) | 12k+ | SFT, DPO, RLHF training |
| [openai/openai-cookbook](https://github.com/openai/openai-cookbook) | 62k+ | Official OpenAI examples and best practices |
| [anthropics/anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook) | 8k+ | Official Claude/Anthropic examples |
| [mlabonne/llm-course](https://github.com/mlabonne/llm-course) | 42k+ | Excellent LLM engineering course with notebooks |

### RAG and Vector Search

| Repo | Stars | Why Study It |
|------|-------|-------------|
| [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | 97k+ | Most popular LLM orchestration framework |
| [run-llama/llama_index](https://github.com/run-llama/llama_index) | 38k+ | Alternative to LangChain, strong for RAG |
| [chroma-core/chroma](https://github.com/chroma-core/chroma) | 16k+ | Most popular local vector database |
| [qdrant/qdrant](https://github.com/qdrant/qdrant) | 21k+ | High-performance vector DB for production |
| [pgvector/pgvector](https://github.com/pgvector/pgvector) | 13k+ | Vector search in PostgreSQL |
| [BerriAI/litellm](https://github.com/BerriAI/litellm) | 16k+ | Unified interface to 100+ LLM APIs |

### Agents and Tool Use

| Repo | Stars | Why Study It |
|------|-------|-------------|
| [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | 10k+ | Graph-based stateful agent framework |
| [openai/swarm](https://github.com/openai/swarm) | 18k+ | OpenAI's lightweight multi-agent framework |
| [microsoft/autogen](https://github.com/microsoft/autogen) | 37k+ | Multi-agent conversation framework |
| [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | 26k+ | Role-based multi-agent framework |
| [anthropics/model-context-protocol](https://github.com/anthropics/model-context-protocol) | Growing | MCP standard for tool integration |

### Fine-tuning

| Repo | Stars | Why Study It |
|------|-------|-------------|
| [unslothai/unsloth](https://github.com/unslothai/unsloth) | 22k+ | 2-4x faster fine-tuning with less memory |
| [axolotl-ai-cloud/axolotl](https://github.com/axolotl-ai-cloud/axolotl) | 9k+ | Powerful fine-tuning config framework |
| [huggingface/alignment-handbook](https://github.com/huggingface/alignment-handbook) | 5k+ | Official HF recipes for SFT and DPO |
| [hiyouga/LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory) | 40k+ | Easy fine-tuning for many models |
| [mlabonne/llm-datasets](https://github.com/mlabonne/llm-datasets) | 2k+ | Curated LLM fine-tuning datasets |

### MLOps and Deployment

| Repo | Stars | Why Study It |
|------|-------|-------------|
| [mlflow/mlflow](https://github.com/mlflow/mlflow) | 19k+ | Experiment tracking and model registry |
| [wandb/wandb](https://github.com/wandb/wandb) | 9k+ | Weights & Biases experiment tracking |
| [vllm-project/vllm](https://github.com/vllm-project/vllm) | 44k+ | Fast LLM inference and serving |
| [tiangolo/fastapi](https://github.com/tiangolo/fastapi) | 80k+ | Fast API framework for ML serving |
| [gradio-app/gradio](https://github.com/gradio-app/gradio) | 34k+ | Build ML demos in minutes |
| [streamlit/streamlit](https://github.com/streamlit/streamlit) | 36k+ | Data apps with pure Python |

### Evaluation

| Repo | Stars | Why Study It |
|------|-------|-------------|
| [explodinggradients/ragas](https://github.com/explodinggradients/ragas) | 7k+ | RAG evaluation framework |
| [openai/evals](https://github.com/openai/evals) | 14k+ | OpenAI's evaluation framework |
| [EleutherAI/lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) | 7k+ | Industry standard LLM benchmarking |
| [huggingface/evaluate](https://github.com/huggingface/evaluate) | 2k+ | Metrics for ML models |
