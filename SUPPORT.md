...
### Common Issues
- **Installation Problems**: See [00-course-setup/README.md#troubleshooting](00-course-setup/README.md)
- **Python Environment**: Check [setup.md](setup.md) for environment configuration
...
- [Kaggle](https://kaggle.com) - Data science competitions and learning
